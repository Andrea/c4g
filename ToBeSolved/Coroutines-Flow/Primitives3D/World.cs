...
//		    _channel = 
		...
		{
            // TODO: using the channel get a future value, so that you can resume execution after that certain
            //future value is set
            
            //hint:
		    //IFuture<bool> extract = 
		    // ...
		    ...
		    while (true)
			{
				...
				// TOOD: make sure you return to this execution point after 5 seconds 
			}
		}        
